# Generated by Django 4.2 on 2023-09-29 20:07
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('product', '0037_alter_review_created_at'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_cart', models.CharField(choices=[('InProgress', 'InProgress'), ('Completed', 'Completed')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_detail', to='orders.cart')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status_order', models.CharField(choices=[('Recieved', 'Recieved'), ('Processed', 'Processed'), ('Shipped', 'Shipped'), ('Delivered', 'Delivered')], max_length=10)),
                ('code', models.CharField(default=utils.generate_code.generate_code, max_length=40)),
